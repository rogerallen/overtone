...
;; See the guitar.clj for how to use this macro.  Other instruments may
;; follow...bass-guitar, ukelele, mandolin, etc...
;; and overtone/examples/instruments/guitar_inst.clj for example usage
...
;; a low-pass filter.  Note: the strings need to be silenced with a
;; gate -> 0 transition before a gate -> 1 transition activates it.
;; Testing showed it needed > 25 ms between these transitions to be
;; effective.  Use the pluck-strings and strum-strings helper
;; functions.
